...
<script src="{{url('/design/adminlte')}}/bower_components/datatables.net-bs/js/buttons.colVis.min.js"></script>
<script src="{{url('/design/adminlte')}}/bower_components/datatables.net-bs/js/buttons.flash.min.js"></script>
<script src="{{url('/design/adminlte')}}/bower_components/datatables.net-bs/js/buttons.html5.min.js"></script>
<script src="{{url('/design/adminlte')}}/bower_components/datatables.net-bs/js/buttons.foundation.min.js"></script>
<script src="{{url('/design/adminlte')}}/bower_components/datatables.net-bs/js/buttons.print.min.js"></script>
<script src="{{url('/design/adminlte')}}/bower_components/datatables.net-bs/js/buttons.semanticui.min.js"></script>
<script src="{{url('/design/adminlte')}}/bower_components/datatables.net-bs/js/buttons.flash.min.js"></script>
